...
def leaderboard_url(tournament):
    ...
    :param tournament: tournament dictionary retrieved from schedule_url()
    ...
    driver.get(basic_leaderboard_url())
    ...
    for item in performance_log:
        if base_url() in item['message'] and message in item['message']:
    ...
    urls.append('{}/{}/{}/leaderboard-v2.json?{}{}{}{}'.format(base_url(), tournament_id, tournament_year, id_str, user_id, acl_str, acl))
